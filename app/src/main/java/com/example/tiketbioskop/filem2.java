...
public class filem2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buyTiketButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(filem2.this, Pemesanan.class);
                intent.putExtra("FILM_NAME", "PEREWANGAN"); // Ganti dengan nama film yang sesuai
