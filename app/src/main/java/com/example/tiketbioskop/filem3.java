...
public class filem3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buyTiketButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(filem3.this, Pemesanan.class);
                intent.putExtra("FILM_NAME", "VENOM: THE LAST DANCE"); // Ganti dengan nama film yang sesuai
